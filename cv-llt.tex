...
\leftheader{%
  {\LARGE\bfseries\sffamily Agustín Nolasco} \\[6pt]

  \makefield{\faEnvelope[regular]}{\href{mailto:franconolasco99@gmail.com}{\texttt{franconolasco99@gmail.com}}}
  ...
  %\makefield{\faPhone}{\texttt{+54 9 2657 58-5595}}
  %\makefield{\faLinkedin}{\href{https://www.linkedin.com/in/agustin-nolasco/}{\texttt{LinkedIn}}}
  \makefield{\faGlobe}{\href{https://agusnolasco.github.io/}{\texttt{Personal Website}}}
  \makefield{\faGithub}{\href{https://github.com/AgusNolasco}{\texttt{GitHub}}}
...
\makerubric{teaching}
\makerubric{industrial}
\input{publications}
\makerubric{courses}
\makerubric{researchprojects}
